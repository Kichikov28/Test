...
public class CompanyController
{
    ...
    public string RentBuilding(List<string> args)
    {
        ...
        else if (!companies[companyName].GetBuildingByName(buildingName).IsAvailable)
        {
            return $"Building: {buildingName} cannot be rented!";
        }
        double bonus = companies[companyName].GetBrokerByName(brokerName).ReceiveBonus(companies[companyName].GetBuildingByName(buildingName));
